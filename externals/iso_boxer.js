...
ISOBoxer.Utils.dataViewToString = function(dataView, encoding) {
  ...
  if (encoding === 'utf-8') {
      ...
      while (i < dataView.byteLength) {
          a.push(String.fronCharCode(dataView.getUint8(i)));
      }
  }
  return a.join('');  
};
...
ISOBox.prototype._boxParsers['vlab'] = function() {
  this.source_label_utf8 = new DataView(this._raw.buffer, this._cursor.offset, this._raw.byteLength - (this._cursor.offset - this._offset));
};
// ISO/IEC 14496-30:2014 - WebVTT Configuration Box
ISOBox.prototype._boxParsers['vttC'] = function() {
  this.config_utf8 = new DataView(this._raw.buffer, this._cursor.offset, this._raw.byteLength - (this._cursor.offset - this._offset));
};
